    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.cardsContainer}>
                {users.length === 0
                    ? <Text style={styles.empty}> Não existem mais desenvolvedores na sua area :( </Text>
                    : (
            ...
            {users.length > 0 && (
                <View style={[styles.buttonContainer, { zIndex: 0 }]}>
                    <TouchableOpacity style={styles.button} onPress={handleDisliked}>
